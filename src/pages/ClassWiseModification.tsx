...
const ClassWiseModification = () => {
  ...
  const handleUpload = () => {
    ...
    toast.success(`File "${file.name}" uploaded for modification`);
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <Card className="max-w-xl mx-auto">
        <CardHeader>
          <CardTitle>Class-wise Data Modification</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <p className="text-sm text-gray-600">
            Upload an Excel file containing multiple student records to modify. The file should follow the required format.
          </p>
          ...
          <Button 
            ...
            disabled={!file}
          >
            <Upload className="mr-2 h-4 w-4" /> Upload For Modification
          </Button>
        </CardContent>
      </Card>
    </div>
...
export default ClassWiseModification;
