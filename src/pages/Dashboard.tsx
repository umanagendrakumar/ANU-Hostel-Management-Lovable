...
// import HostelAdmissionFee from './HostelAdmissionFee';
// import HostelAdmissionFeeDetails from './HostelAdmissionFeeDetails';
// // import MessDueFee from './MessDueFee';
// // import MessDueFeeDetails from './MessDueFeeDetails';
      ...
      <div className="flex-1 p-4 md:p-6 overflow-auto">
        {isHomePage ? (
          ...
          <Routes>
            ...
            {/* Fee Payment Routes */}
            <Route path="fee-payment" element={<FeePayment />} />
            <Route path="fee-payment/hostel-admission" element={<HostelAdmissionFee />} />
            <Route path="fee-payment/hostel-admission/details/:id" element={<HostelAdmissionFeeDetails />} />
            <Route path="fee-payment/mess-due" element={<MessDueFee />} />
            <Route path="fee-payment/mess-due/details/:id" element={<MessDueFeeDetails />} />
            <Route path="fee-payment/other-fees" element={<ConstructionPage />} />
