...
const HostelAdmissionFee = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    navigate(`/dashboard/fee-payment/hostel-admission/details/${hostelId}`);
  };
    ...
    <div className="container mx-auto p-4 md:p-6 animate-fadeIn">
      ...
      <Card className="max-w-xl mx-auto shadow-md hover:shadow-lg transition-all duration-300">
        <CardHeader className="pb-2">
          <CardTitle className="text-xl md:text-2xl">Hostel Admission Fee Payment</CardTitle>
        </CardHeader>
        <CardContent>
...
export default HostelAdmissionFee;
